...
class DashScatterBoard(Component):
    """A DashScatterBoard component.
...
- clickData (dict; optional): Click data
- hoverData (dict; optional): Hover data"""
    @_explicitize_args
    def __init__(self, data=Component.UNDEFINED, shapeKey=Component.UNDEFINED, colorKey=Component.UNDEFINED, labelKeys=Component.UNDEFINED, searchKeys=Component.UNDEFINED, width=Component.UNDEFINED, height=Component.UNDEFINED, is3d=Component.UNDEFINED, id=Component.UNDEFINED, clickData=Component.UNDEFINED, hoverData=Component.UNDEFINED, **kwargs):
        self._prop_names = ['data', 'shapeKey', 'colorKey', 'labelKeys', 'searchKeys', 'width', 'height', 'is3d', 'id', 'clickData', 'hoverData']
        self._type = 'DashScatterBoard'
        self._namespace = 'react_scatter_board'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['data', 'shapeKey', 'colorKey', 'labelKeys', 'searchKeys', 'width', 'height', 'is3d', 'id', 'clickData', 'hoverData']
        ...
        super(DashScatterBoard, self).__init__(**args)
